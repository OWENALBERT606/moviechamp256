    ...
    <section className="relative">
      ...
      >
        {series.map((s) => (
          <div
            key={s.id}
            className="group cursor-pointer min-w-0 relative overflow-hidden rounded-lg bg-card transition-transform duration-300 hover:scale-105 hover:z-10"
          >
            {/* Poster Image */}
            <div className="relative aspect-[2/3] w-full">
              ...
              <div className="absolute bottom-16 left-3 right-3 flex gap-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300 z-20 pointer-events-auto">
                ...
                {s.isComingSoon ? (
                  <Button 
                    className="h-8 w-8 rounded-full bg-blue-600 hover:bg-blue-700 p-0 flex items-center justify-center"
                    disabled
                    title="Coming Soon"
                  >
                  ...
                  <Link href={`/series/${s.slug}`}>
                    <Button 
                      className="h-8 w-8 rounded-full bg-orange-500 hover:bg-orange-600 p-0 flex items-center justify-center"
                      title="Play"
                    >
              ...
              <div className="absolute top-2 right-2 z-10">
                <div className="flex items-center gap-1 bg-orange-500 text-white rounded px-1.5 py-0.5">
                  <Star className="w-2.5 h-2.5 fill-white text-white" />
                  <span className="text-[10px] font-bold">{s.rating.toFixed(1)}</span>
                </div>
              </div>
              ...
              {s.isTrending && !s.isComingSoon && (
                <div className="absolute top-2 left-2 z-10">
                  <span className="px-1.5 py-0.5 bg-red-600 text-white text-[10px] font-semibold rounded flex items-center gap-1">
                    <span>🔥</span>
                    <span>Trending</span>
                  </span>
                </div>
              ...
              {s.isComingSoon && (
                <div className="absolute top-2 left-2 z-10">
                  <span className="px-1.5 py-0.5 bg-blue-600 text-white text-[10px] font-semibold rounded animate-pulse flex items-center gap-1">
