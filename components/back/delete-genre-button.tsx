...
export function DeleteGenreButton({ genre }: DeleteGenreButtonProps) {
    ...
    <AlertDialog open={isOpen} onOpenChange={setIsOpen}>
      <AlertDialogTrigger asChild>
        ...
        //   disabled={hasMovies}
          title={
            hasMovies
              ? "Cannot delete genre with movies"
              : "Delete genre"
          }
        >
      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>
            Are you sure you want to delete <strong>{genre.name}</strong>? This
