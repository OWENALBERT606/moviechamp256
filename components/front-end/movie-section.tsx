...
export function MovieSection({ title, movies }: MovieSectionProps) {
  ...
  return (
    <section className="relative">
      ...
      <div
        id={`scroll-${title.replace(/\s+/g, "-")}`}
        className="grid grid-cols-4 md:grid-cols-6 lg:grid-cols-8 gap-4 overflow-x-auto scrollbar-hide pb-4"
        style={{ scrollbarWidth: "none", msOverflowStyle: "none" }}
      >
        {movies.map((movie) => (
          <div
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-2">
                      ...
                      <Button
                        ...
                        size="sm"
                        variant="outline"
                        className="border-white/20 hover:bg-primary bg-slate-400/30"
                      >
                        <Plus className="w-4 h-4" />
                      </Button>
                      <Button
